...
BEGIN
    INSERT INTO Ticket (ticket_id,, TICKET_SYSTEM_ID, srst_id, purchase_date, fare)
...
BEGIN
    ...
    Ticketing_System_Pkg.Add_Ticketing_Entry(10, 'Wellington', 'Assembly');
    Ticketing_System_Pkg.Add_Ticketing_Entry(11, 'Downtown Crossing', 'Chinatown');
    Ticketing_System_Pkg.Add_Ticketing_Entry(12, 'Roxbury Crossing', 'Jackson Square');
    COMMIT;
END;
/
